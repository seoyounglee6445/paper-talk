...
async function createPost(request, env) {
  ...
  return json({
    ok: true,
    message: "Submitted. 관리자 승인 후 공개됩니다."
  });
}
...
function renderPost(p) {
  return \`
    <article class="card">
      ...
      <p class="meta">\${escapeHtml(labelType(p.type))} · \${new Date(p.created_at).toLocaleDateString()}</p>
...
async function loadPending() {
  ...
  box.innerHTML = data.posts.map(p => \`
    <article class="card">
      <h3>\${escapeHtml(p.title)}</h3>
      <p class="meta">\${escapeHtml(p.section)} · \${escapeHtml(labelType(p.type))}</p>
      <p>\${escapeHtml(p.body)}</p>
      \${p.link ? \`<p><a class="btn" href="\${escapeHtml(p.link)}" target="_blank">Open Link</a></p>\` : ""}
      \${p.linkedin_url ? \`<p><a class="btn" href="\${escapeHtml(p.linkedin_url)}" target="_blank">LinkedIn</a></p>\` : ""}
...
<div class="notice">
  ...
  if (type === "community") {
    return `
<h1>Community</h1>
<p>Community는 질문/토론과 학회공고 두 가지 카테고리로 운영됩니다.</p>

<section class="category-grid">
  <div class="category-card">
    <h2>질문 / 토론</h2>
    <p>연구, 논문, 분석, 커리어에 대한 질문과 토론을 올릴 수 있습니다.</p>
  </div>

  <div class="category-card">
    <h2>학회 공고</h2>
    <p>학회, 워크숍, 세미나, 컨퍼런스 공고를 공유할 수 있습니다.</p>
  </div>
</section>
...
<div id="pagination" class="pagination"></div>`;
  ...
  if (type === "career") {
    return `
<h1>Career</h1>
<p>Career는 LinkedIn 자기 홍보와 구인공고 두 가지 카테고리로 운영됩니다.</p>

<section class="category-grid">
  <div class="category-card">
    <h2>LinkedIn 자기 홍보</h2>
    <p>자신의 LinkedIn 프로필을 등록하고 연구 경력과 관심 분야를 소개할 수 있습니다.</p>
  </div>

  <div class="category-card">
    <h2>구인공고</h2>
    <p>연구실, 병원, 기업, 스타트업의 채용공고를 공유할 수 있습니다.</p>
  </div>
</section>
